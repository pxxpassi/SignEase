...
class MyHome extends StatefulWidget {
  ...
  const MyHome({Key? key, required this.cameras}) : super(key: key); // Update the constructor
...
class _CameraScreenState extends State<CameraScreen> {
  ...
  void initState() {
    super.initState();
    print('Number of available cameras: ${widget.cameras.length}');
    ...
    // Initialize _initializeControllerFuture here
